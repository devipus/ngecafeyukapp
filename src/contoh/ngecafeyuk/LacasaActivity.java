...
public class LacasaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_lacasa);
		...
		call.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				call.setData(Uri.parse("tel:082375700052"));
				startActivity(call);
			}
		});
		...
		clock.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				if(clock.isEnabled()){
					...
					text.setText("JAM BUKA : 12:00 - 22:00 WIB");
				} else {
		...
		money.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				if(money.isEnabled()){
					detail.setVisibility(View.VISIBLE);
					text.setText("MULAI DARI : 34,5K - 97K");
				} else {
					detail.setVisibility(View.GONE);
				}
			}
		...
		place.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent pindah = new Intent(LacasaActivity.this, PosLacasa.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.lacasa, menu);
		return true;
	}
