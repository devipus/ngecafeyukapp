...
public class OmgantengActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_omganteng);
		...
		call.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				call.setData(Uri.parse("tel:08972247603"));
				startActivity(call);
			}
		});
		...
		clock.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				if(clock.isEnabled()){
					...
					text.setText("JAM BUKA : 18:00 - 23:00 WIB");
				} else {
		...
		money.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				if(money.isEnabled()){
					detail.setVisibility(View.VISIBLE);
					text.setText("MULAI DARI : 3K-32K");
				} else {
					detail.setVisibility(View.GONE);
				}
			}
		...
		place.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent pindah = new Intent(OmgantengActivity.this, PosTaiGanteng.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.omganteng, menu);
		return true;
	}
