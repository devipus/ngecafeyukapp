...
public class StarbuckActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		call.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				call.setData(Uri.parse("tel:07115649248"));
				startActivity(call);
			}
		});
		...
		clock.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				if(clock.isEnabled()){
					...
					text.setText("JAM BUKA : 07:00 - 22:00 WIB");
				} else {
		...
		money.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				if(money.isEnabled()){
					detail.setVisibility(View.VISIBLE);
					text.setText("MULAI DARI : 25K - 62K");
				} else {
					detail.setVisibility(View.GONE);
				}
			}
		...
		place.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent pindah = new Intent(StarbuckActivity.this, PosStarbucks.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.starbuck, menu);
		return true;
	}
