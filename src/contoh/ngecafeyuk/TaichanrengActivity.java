...
public class TaichanrengActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_taichanreng);
		...
		clock.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				if(clock.isEnabled()){
					detail.setVisibility(View.VISIBLE);
					text.setText("JAM BUKA : 11:00 - 23:00 WIB");
				} else {
					detail.setVisibility(View.GONE);
				}
			}
		...
		money.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				if(money.isEnabled()){
					detail.setVisibility(View.VISIBLE);
					text.setText("MULAI DARI : 25K - 35K");
				} else {
					detail.setVisibility(View.GONE);
				}
			}
		...
		place.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent pindah = new Intent(TaichanrengActivity.this, PosTaigor.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.taichanreng, menu);
		return true;
	}
