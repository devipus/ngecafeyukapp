...
public class UpnormalActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_upnormal);
		...
		call.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				call.setData(Uri.parse("tel:0711365913"));
				startActivity(call);
			}
		});
		...
		clock.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				if(clock.isEnabled()){
					...
					text.setText("JAM BUKA : 08:00 - 00:00 WIB");
				} else {
		...
		money.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				if(money.isEnabled()){
					detail.setVisibility(View.VISIBLE);
					text.setText("MULAI DARI : 16K - 43K");
				} else {
					detail.setVisibility(View.GONE);
				}
			}
		...
		place.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent pindah = new Intent(UpnormalActivity.this, PosUpnormal.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.upnormal, menu);
		return true;
	}
