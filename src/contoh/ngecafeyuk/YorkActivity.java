...
public class YorkActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		call.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				call.setData(Uri.parse("tel:081379326065"));
				startActivity(call);
			}
		});
		...
		money.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				if(money.isEnabled()){
					detail.setVisibility(View.VISIBLE);
					text.setText("MULAI DARI : 20K-  150K,- PERHIDANGAN");
				} else {
					detail.setVisibility(View.GONE);
				}
			}
		...
		place.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent pindah = new Intent(YorkActivity.this, PosYork.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.york, menu);
		return true;
	}
